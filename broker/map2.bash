...
while true; do
    ...
    mosquitto_pub -h 127.0.0.1 \
    -m '{"mapWidth":1000,"mapHeight":1000,"checkpoints":[{"id":1,"x":600,"y":50},{"id":2,"x":60,"y":250},{"id":3,"x":400,"y":450},{"id":4,"x":800,"y":250}],"obstacles":[{"id":1,"angle":0,"x":350,"y":250},{"id":2,"angle":0,"x":200,"y":750},{"id":3,"angle":0,"x":700,"y":750},{"id":4,"angle":0,"x":600,"y":250}]}' \
    -t map
    sleep 1
done
